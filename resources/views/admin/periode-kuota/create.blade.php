...
@section('content')
    <div class="mb-6">
        <h1 class="text-xl font-semibold text-tinta">Tambah Periode Kuota</h1>
        <p class="mt-1 text-sm text-lembut">Buat periode kuota residu baru untuk sebuah kawasan.</p>
    </div>
